...
#
#     def count_product_in_db(
#         self,
#     ):  # My own test for practice (not part of learning class)
...
#         sql = (
#             f"SELECT * FROM new_kwaki.wp_posts WHERE post_type = 'product' AND post_status = 'publish' AND "
