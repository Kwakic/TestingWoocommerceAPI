# 🗂️ Using Allure with this project

---

# 📈 Allure report generated by CI (GitHub) — how to actually view it
...
## ✅ Option A — Download & open locally (fastest)
### Step 1 — Download artifact

In GitHub:
```
Actions → your workflow → Artifacts → allure-report → Download
```
---
...
❗If the port 8080 is blocked or already in use: `PermissionError: [WinError 10013]`
...
Allure uses JS → needs HTTP server
Otherwise you’ll see broken UI


---

## ✅ Option B — Publish Allure report automatically (best practice)

You already use:
```
peaceiris/actions-gh-pages
```
👉 That means your report is likely already deployed

---

### 🔍 Find your report URL
...
### 🔐 If not visible → enable GitHub Pages
...
This a code to be added into the `ci.yml` file:
...
Add this to your workflow summary:

This step:
```YAML
- name: Print Allure URL
  run: echo "Allure Report: https://${{ github.repository_owner }}.github.io/${{ github.event.repository.name }}/"
```
👉 simply prints a clickable link in your GitHub Actions logs
...
* You run pipeline
* Then manually build URL in your head

With this:

* The pipeline itself tells you:

`Allure Report: https://kwakic.github.io/TestingWoocommerceAPI`
