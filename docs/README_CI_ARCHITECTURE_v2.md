# 🏗️ Enterprise CI Architecture Guide

> This document explains the architecture of the CI/CD platform.

## Recommended reading order

1. CI/CD Philosophy
2. Repository Architecture
3. Enterprise CI Flow
...
The framework is the **Single Source of Truth**. GitHub Actions consumes framework metadata instead of maintaining its own configuration.
...
|---|---|
| Single Source of Truth | Framework owns discovery and metadata. |
| Dynamic Entity Discovery | CI never maintains hardcoded entity lists. |
| Reusable Pipelines | Test execution and report generation are shared. |
| Independent Deployment | GitHub Pages deployment is decoupled from testing. |
| Entity-first Reports | Reports are published as `entity/suite`. |
