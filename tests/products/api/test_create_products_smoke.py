...
# from tests.shared.contracts.error_schema import error_schema
#
# # from EcommerceAPI.src.products.helpers import products_helper
# # from EcommerceAPI.src.products.dao import products_dao
#
...
#         10, prefix="Test"
#     )  # # For the name, we don't want to hardcode the
...
#     payload = {"name": name, "type": "simple", "regular_price": "10.95"}
#
#     # 2. Make the call (we have to create within our 'products_helper' a function to create a product)
#     product_rs = ProductsHelper().call_create_product(
#         payload
#     )  # We don't need to create an object and assign it to a
...
#         f"Create product API call response has unexpected name. Expected "
