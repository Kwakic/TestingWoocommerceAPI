...
# def test_deleted_customer_not_in_created_after_filter(all_resources, create_valid_customer, minute_offset: int):
#     """
...
#     # When to Use skip_cleanup=True Then? You only need it when: You're not calling mark_deleted(...), and You're
...
#     assert customer_id, "❌ Customer ID missing from response"
#     assert customer_email, "❌ Customer email missing from response"
...
#     # Prevents stale or logically removed data from leaking into client apps
#
#
#
