...
#
# @pytest.mark.tcid09
# def test_get_all_customers_list_not_empty_and_valid_schema(all_resources):
#     """
...
# @pytest.mark.tcid10
# def test_get_all_customers_pagination_boundary(all_resources):
...
# @pytest.mark.regression
# @pytest.mark.tcid11
# def test_get_all_customers_empty_list_with_mock(all_resources):
#     """
...
#
# # Mocking the empty DB scenario is a great idea for a QA test — it isolates the API behavior without requiring real
# # DB changes and keeps tests reliable and fast.
#
#
# @pytest.mark.negative_test
# @pytest.mark.tcid19
# def test_list_customers_created_in_the_future_returns_empty(all_resources):
#     """
